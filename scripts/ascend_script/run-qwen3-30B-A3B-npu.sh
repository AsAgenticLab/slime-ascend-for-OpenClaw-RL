...
CKPT_ARGS=(
   --hf-checkpoint /path/to/models/Qwen3-30B-A3B
   --ref-load /path/to/models/Qwen3-30B-A3B_torch_dist
   --load /path/to/models/Qwen3-30B-A3B/
   --save /path/to/models/Qwen3-30B-A3B/
   --save-interval 100
)
